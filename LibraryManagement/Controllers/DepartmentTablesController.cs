...
namespace LibraryManagement.Controllers
{
    public class DepartmentTablesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "DepartmentID,DepartmentName,UserID")] DepartmentTable departmentTable)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "DepartmentID,DepartmentName,UserID")] DepartmentTable departmentTable)
        {
            if (ModelState.IsValid)
            {
