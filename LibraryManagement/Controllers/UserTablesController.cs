...
namespace LibraryManagement.Controllers
{
    public class UserTablesController : Controller
    {
        ...
        {
            ViewBag.EmployeeID = new SelectList(db.EmployeeTables, "EmployerID", "FullName");
        ...
        public ActionResult Create([Bind(Include = "UserID,UserTypeID,UserName,Password,EmployeeID,IsActive")] UserTable userTable)
        {
            ...
            ViewBag.EmployeeID = new SelectList(db.EmployeeTables, "EmployerID", "FullName", userTable.EmployeeID);
